...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('mitra.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="tahun_awal_kerjasama" id="tahun_awal_kerjasama" required
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="text" name="tahun_akhir_kerjasama" id="tahun_akhir_kerjasama" required
