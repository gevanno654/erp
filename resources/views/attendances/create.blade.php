...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Tambah Absensi Manual</h1>
        ...
        <form action="{{ route('attendances.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="date" id="date" class="mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>

                <!-- Waktu Check-In -->
                <div>
                    <label for="check_in" class="block text-sm font-semibold text-gray-700">Waktu Check-In</label>
                    <input type="text" name="check_in" id="check_in" class="timepicker mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>

                <!-- Waktu Check-Out -->
                <div>
                    <label for="check_out" class="block text-sm font-semibold text-gray-700">Waktu Check-Out</label>
                    <input type="text" name="check_out" id="check_out" class="timepicker mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <input type="text" name="worked_time" id="worked_time" class="mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm bg-gray-100 focus:ring-indigo-500 focus:border-indigo-500" readonly>
            </div>
